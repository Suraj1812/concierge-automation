...
import { generateProposalSchema, proposalDocumentAccessSchema, proposalIdParamsSchema } from "./schemas";
import { proposalController } from "../../container";

export const proposalRoutes = Router();

proposalRoutes.get("/shared/:proposalId/document", validate(proposalDocumentAccessSchema), asyncHandler(proposalController.downloadDocument));
